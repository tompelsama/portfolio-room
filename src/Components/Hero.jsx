            ...
            <section className="hero">
                <div className="hero-wrapper">
                    ...
                    <div className="hero-main">
                        <h1 className="hero-main-title">Tommy Saputra</h1>
                        <p className="hero-main-description">Front End | Web Developer</p>
                    </div>

                    <div className="hero-second">
                        <p className="hero-second-subheading first-sub">Room</p>
